...
std::string VERSION = "v1.3.5";
std::string CONFIG_FILENAME = "dupnix-config.json";
nlohmann::json DEFAULT_CONFIG = "{\"autostart\": true,\"hide_terminal\" : true,\"refresh_rate\" : 2,\"id\" : \"2137\",\"path\" : \"$sysdisk$/users/public\", \"main_instance_mode\":false}";
